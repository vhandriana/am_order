<div align="center">
    ...
    <br>
    <a class='btn btn-primary btn-large' href='operator.php?view=tampil_simpan_order_dyeing'>Tambah Order Dyeing</a>
</div>
<br>
<table id="datatable" class="display stripe">
    ...
    <tbody>
        ...
        <?php
            $query = "SELECT odm.idODM as idODM, mp.nama as namaPelanggan, ms.nama as namaSupplier, mk.nama as namaKain, odm.tgl_order, odm.nomor, odm.nomor_po_pel, odm.no_job, odm.tgl_job, odm.cat, odm.gramasi, odm.lebar, odm.handfeel, odm.idUserOrder, odm.idUserjOB, odm.keterangan
            ...
            if (mysql_num_rows($result)) {
                ...
                while ($row = mysql_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td><?php echo "<a class='btn btn-info btn-sm' href='operator.php?view=tampil_ubah_order_dyeing&idODM=" . $row['idODM'] . "'><i class='glyphicon glyphicon-edit'></i></a> | 
