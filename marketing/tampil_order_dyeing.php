        ...
        <?php
            ...
            if (mysql_num_rows($result)) {
                ...
                while ($row = mysql_fetch_array($result)) {
                    ...
                    <tr>
                        <td><?php echo $no; ?> </td>
                        <td><?php echo "<a class='btn btn-info btn-sm' href='marketing.php?view=tampil_ubah_order_dyeing&idODM=" . $row['idODM'] . "'><i class='glyphicon glyphicon-eye-open'></i></a> ";
                        ?></td>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("button#submit").click(function () {
            $.ajax({
                type: "POST",
                url: "marketing/aksi_tambah_odm.php",
                data: $('form#aksi_tambah_odm').serialize(),
                success: function (msg) {
                    $("#tambahModal").modal('hide')
                    location.href = 'marketing.php?view=tampil_odm';
                    ;
                },
                error: function () {
