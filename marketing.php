                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            <li <?php if (isset($_GET['view'])) {
                                ...
                                <a href="marketing.php?view=tampil_order_dyeing">Order Dyeing
                                </a>
                            </li> 
                        </li>
                    </ul>
                    ...
                    <div class="panel panel-default" style="overflow: auto;"> 
                        <div class="panel-body">
                            <?php
                                if (isset($_GET['view'])) {
                                    $view = $_GET['view'];
                                    include 'marketing/' . $view . '.php';
                                } else {
                                    header("location:marketing.php?view=tampil_user");
                                }
                            ?>
                        </div>
                    </div>
