                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li <?php if (isset($_GET['view'])) {
                                    ...
                                    <a href="operator.php?view=tampil_kain">
                                        Kain
                                    </a>
                                </li>
                                ...
                                <li <?php if (isset($_GET['view'])) {
                                    ...
                                    <a href="operator.php?view=tampil_pelanggan">
                                        Pelanggan
                                    </a>
                                </li>
                                ...
                                <li <?php if (isset($_GET['view'])) {
                                    ...
                                    <a href="operator.php?view=tampil_supplier">
                                        Supplier
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li <?php if (isset($_GET['view'])) {
                                    ...
                                    <a href="operator.php?view=tampil_order_dyeing">
                                        Order Dyeing
                                    </a>
                                </li>
